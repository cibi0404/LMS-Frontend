              ...
              <div className="row">
                <div className="col-lg-8 entries">
                  <article className="entry entry-single">
                    ...
                    <>
                     {rate==5?(<><p>course completed</p></>):(<>  <Button variant="outline-success" onClick={completedChapter()}>
                      Completed
                    </Button></>)}
                    
                    </>
                  
                  ):(<> <Button variant="outline-success" onClick={handleNextChapter} disabled={currentChapterIndex === chapters.length - 1}>
                      Next Chapter
                    </Button></>)}
